...
if (isset($_POST['edit'])) {
    ...
    $tanggal_kembalian = mysqli_real_escape_string($connect, $_POST['tanggal_kembalian']);
...
<body>
    ...
    <form method="POST">
        ...
        Tanggal Pinjam
        <input type="date" name="tanggal_pinjam" value="<?= htmlspecialchars($data['tanggal_pinjam'])?>" required><br>
        
        Tanggal Kembalian
        <input type="date" name="tanggal_kembalian" value="<?= htmlspecialchars($data['tanggal_kembalian'])?>" required><br>
